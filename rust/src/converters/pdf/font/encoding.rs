//! Simple-font encodings: the named base encodings (WinAnsi, MacRoman,
//! Standard), the Symbol and ZapfDingbats built-ins, and the
//! /Encoding + /Differences resolution that fills a font's per-byte
//! unicode table.
...
pub(crate) fn build_simple_encoding(pdf: &Pdf, dict: &Dict, info: &mut FontInfo) {
